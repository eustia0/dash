...
import pandas as pd
from dash import dash_table as dt  # Updated import

sales = pd.read_csv('train.csv', encoding='ISO-8859-1')
# Correctly specify the format for 'Order Date'
sales['Order Date'] = pd.to_datetime(sales['Order Date'], format='%d/%m/%Y')  # Correct format specified
